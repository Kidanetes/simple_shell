...
void free_args(char **argv, char **front);
...
/* Builtins */
int (*get_builtin(char *command))(char **argv, char **front);
int shell_exit(char **argv, char **front);
int shell_env(char **argv, char __attribute__((__unused__)) **front);
int shell_setenv(char **argv, char __attribute__((__unused__)) **front);
int shell_unsetenv(char **argv, char __attribute__((__unused__)) **front);
int shell_cd(char **argv, char __attribute__((__unused__)) **front);
int shell_alias(char **argv, char __attribute__((__unused__)) **front);
int shell_help(char **argv, char __attribute__((__unused__)) **front);
